(function(a){
    a.fn.webwidget_slideshow_dot=function(p){
        ...
        function init(){
            ...
            x.find(".title_thumb_box").append('<div class="thumb_direction"></div>');
            x.find(".thumb_direction").append('<span><img src="'+d+'carousel_back_normal.png" alt="previous"  class="thumb_p"/></span>');
            ...
            x.find(".thumb_direction").append('<span><img src="'+d+'carousel_next_normal.png" alt="next"  class="thumb_n"/></span>');
            ...
            x.find(".thumb_direction").children("span").children("img").click(
                function(){
                    switch($(this).attr("class")){
                        case "thumb_p":
                            previous();
